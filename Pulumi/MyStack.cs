...
namespace TvShowRss
{
    class MyStack : Stack
    {
        ...
        public MyStack()
        {
            ...
            var mainStorage = new StorageAccount("mainStorage", new StorageAccountArgs
            {
            ...
            new WebAppFunction("getFeedFunction", new WebAppFunctionArgs
            {
                ...
                ConfigHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/GetFeed/function.json",
                ...
                Name = resourcesPrefix + "fa",
                ResourceGroupName = resourceGroup.Name,
                ScriptHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/bin/TvShowRss.dll",
                ScriptRootPathHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/GetFeed/",
                TestData = "",
                TestDataHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/tmp/FunctionsData/GetFeed.dat"
            });
            
            new WebAppFunction("addShowFunction", new WebAppFunctionArgs
            {
                Config = new Dictionary<string,object>
                {
                    ["bindings"] = new[] 
                ...
                ConfigHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/AddShow/function.json",
                ...
                ResourceGroupName = resourceGroup.Name,
                ScriptHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/bin/TvShowRss.dll",
                ScriptRootPathHref = $"https://{resourcesPrefix}fa.azurewebsites.net/admin/vfs/home/site/wwwroot/AddShow/",
                TestData = "",
            ...
            var appSecrets = new Vault("appSecrets",
                new VaultArgs
                {
                    Location = resourceGroup.Location,
                    Properties = new VaultPropertiesArgs
                    {
                        ...
                        AccessPolicies =
                        {
                            ...
                            new AccessPolicyEntryArgs
                            {
                                ObjectId = functionApp.Identity.Apply(x => x?.PrincipalId ?? throw new Exception("Missing function identity")),
                                Permissions = new PermissionsArgs
                                {
                                    Secrets =
                                    {
